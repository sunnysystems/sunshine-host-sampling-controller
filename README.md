...
> Versioning, license, and support policy are in place (v1.2.0, Apache-2.0 —
...
```sh
make docker IMAGE=registry.example.com/host-sampling-controller:1.2.0-audit
docker push registry.example.com/host-sampling-controller:1.2.0-audit
helm install host-sampling ... \
  --set image.repository=registry.example.com/host-sampling-controller \
  --set image.tag=1.2.0-audit
```
...
`docker buildx imagetools inspect ghcr.io/sunnysystems/host-sampling-controller:1.2.0`.
